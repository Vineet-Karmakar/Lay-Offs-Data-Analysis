...
-- We can create a new column and add the row numbers in. Then delete rows where row numbers are over 2, then delete that column.
...
-- --------------------------------------------------
-- we also need to look at country column.
